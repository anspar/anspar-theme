...
export default function Moon(props:{onClick?: MouseEventHandler<SVGSVGElement>}){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="100%" className="as-pointer" {...props}>
