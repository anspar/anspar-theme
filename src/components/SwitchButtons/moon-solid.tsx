...
export default function Moon(props:{width?: string, height?: string, onClick?: MouseEventHandler<SVGSVGElement>}){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props} className="as-pointer">
            {/* <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
            <path fill="var(--as-dark)"
